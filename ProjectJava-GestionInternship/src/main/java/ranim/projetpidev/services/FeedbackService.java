...
public class FeedbackService implements IServices<Feedback> {
    ...
    public void add(Feedback feedback) throws SQLException {
        ...
        try (PreparedStatement pstmt = MyDataBase.getInstance().getCnx().prepareStatement(query)) {
            ...
            pstmt.setDate(5, feedback.getDateFeedback() != null ? new java.sql.Date(feedback.getDateFeedback().getTime()) : null);
            pstmt.executeUpdate();
