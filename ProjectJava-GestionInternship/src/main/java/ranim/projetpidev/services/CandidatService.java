...
public class CandidatService implements IServices<Candidat> {
    ...
    public void add(Candidat candidat) throws SQLException {
        ...
        try (PreparedStatement pstmt = MyDataBase.getInstance().getCnx().prepareStatement(query)) {
            ...
            pstmt.setDate(3, new java.sql.Date(candidat.getDateCandidature().getTime()));
            ...
            pstmt.setDate(12, candidat.getInterviewDate() != null ? new java.sql.Date(candidat.getInterviewDate().getTime()) : null);
            pstmt.executeUpdate();
